...
const clientPg = new Client("postgresql://neondb_owner:npg_YgFASc5yOKu7@ep-old-water-axolmmig-pooler.c-4.us-east-2.aws.neon.tech/neondb?sslmode=verify-full&channel_binding=require");
async function main() {
